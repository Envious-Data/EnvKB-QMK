...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT(
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR, LT(4, KC_SLCK), KC_PAUS,
...
void rgb_matrix_indicators_kb(void) {
	...
	switch (biton32(layer_state)) {
		...
		case 1:
			...
			break;
		case 2:
			rgb_matrix_set_color(83, rgb.r/10, rgb.g/10, rgb.b/10);
			break;
		case 3:
			//rgb_matrix_set_color(i, 0xff, 0xff, 0x00);
			break;
